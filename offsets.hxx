...
namespace Offsets
{
	...
	namespace Pointers
	{
		...
		{
			inline constexpr std::uintptr_t Pointer = 0x8731178;
		}
	...
	namespace FastClusterEntity
	{
		...
		inline constexpr std::uintptr_t VTableRva = 0x6AE1C10;
	}
	...
	namespace Animation
	{
		inline constexpr std::uintptr_t AnimationContent = 0xB8;
		inline constexpr std::uintptr_t AnimationId = 0xC8;
	}
	...
	{
		inline constexpr std::uintptr_t Animation = 0xB8;
		inline constexpr std::uintptr_t Animator = 0x108;
		inline constexpr std::uintptr_t IsPlaying = 0xA50;
	...
	namespace Attachment
	{
		...
		inline constexpr std::uintptr_t Rotation = 0xD0;
	...
	{
		inline constexpr std::uintptr_t EnableCulling = 0x140;
		inline constexpr std::uintptr_t EnableLOD = 0x141;
		inline constexpr std::uintptr_t LODCriticality = 0x138;
		inline constexpr std::uintptr_t Priority = 0x13C;
		inline constexpr std::uintptr_t Source = 0x108;
	}
	...
	{
		inline constexpr std::uintptr_t Disabled = 0x134;
		inline constexpr std::uintptr_t Enabled = 0x134;
		inline constexpr std::uintptr_t LinkedSource = 0x108;
		inline constexpr std::uintptr_t RunContext = 0x130;
	}
	...
	namespace CoreGui
	{
		inline constexpr std::uintptr_t SelectionImageObject = 0x160;
	}
	...
	namespace DataModel
	{
		...
		inline constexpr std::uintptr_t GearGenreSetting = 0x754;
	...
	namespace Decal
	{
		...
		inline constexpr std::uintptr_t Shiny = 0x214;
	...
	namespace ExperienceStateCaptureService
	{
		...
		inline constexpr std::uintptr_t IsInBackground = 0xC5;
	...
	{
		inline constexpr std::uintptr_t AdornCullingMode = 0x154;
		inline constexpr std::uintptr_t AlwaysOnTop = 0x15C;
		inline constexpr std::uintptr_t CFrame = 0x118;
		inline constexpr std::uintptr_t GizmoReference = 0x110;
		inline constexpr std::uintptr_t SizeRelativeOffset = 0x148;
		inline constexpr std::uintptr_t ZIndex = 0x158;
	}
	...
	namespace HumanoidRigDescription
	{
		...
		inline constexpr std::uintptr_t ChestRangeMax = 0x680;
		inline constexpr std::uintptr_t ChestRangeMin = 0x68C;
		inline constexpr std::uintptr_t ChestSize = 0x890;
		inline constexpr std::uintptr_t ChestTposeAdjustment = 0x230;
		inline constexpr std::uintptr_t HeadBase = 0xE0;
		inline constexpr std::uintptr_t HeadBaseRangeMax = 0x698;
		inline constexpr std::uintptr_t HeadBaseRangeMin = 0x6A4;
		inline constexpr std::uintptr_t HeadBaseSize = 0x894;
		inline constexpr std::uintptr_t HeadBaseTposeAdjustment = 0x260;
		inline constexpr std::uintptr_t LeftAnkle = 0xF0;
		inline constexpr std::uintptr_t LeftAnkleRangeMax = 0x6B0;
		inline constexpr std::uintptr_t LeftAnkleRangeMin = 0x6BC;
		inline constexpr std::uintptr_t LeftAnkleSize = 0x898;
		inline constexpr std::uintptr_t LeftAnkleTposeAdjustment = 0x290;
		inline constexpr std::uintptr_t LeftClavicle = 0x100;
		inline constexpr std::uintptr_t LeftClavicleRangeMax = 0x6C8;
		inline constexpr std::uintptr_t LeftClavicleRangeMin = 0x6D4;
		inline constexpr std::uintptr_t LeftClavicleSize = 0x89C;
		inline constexpr std::uintptr_t LeftClavicleTposeAdjustment = 0x2C0;
		inline constexpr std::uintptr_t LeftElbow = 0x110;
		inline constexpr std::uintptr_t LeftElbowRangeMax = 0x6E0;
		inline constexpr std::uintptr_t LeftElbowRangeMin = 0x6EC;
		inline constexpr std::uintptr_t LeftElbowSize = 0x8A0;
		inline constexpr std::uintptr_t LeftElbowTposeAdjustment = 0x2F0;
		inline constexpr std::uintptr_t LeftHip = 0x120;
		inline constexpr std::uintptr_t LeftHipRangeMax = 0x6F8;
		inline constexpr std::uintptr_t LeftHipRangeMin = 0x704;
		inline constexpr std::uintptr_t LeftHipSize = 0x8A4;
		inline constexpr std::uintptr_t LeftHipTposeAdjustment = 0x320;
		inline constexpr std::uintptr_t LeftKnee = 0x130;
		inline constexpr std::uintptr_t LeftKneeRangeMax = 0x710;
		inline constexpr std::uintptr_t LeftKneeRangeMin = 0x71C;
		inline constexpr std::uintptr_t LeftKneeSize = 0x8A8;
		inline constexpr std::uintptr_t LeftKneeTposeAdjustment = 0x350;
		inline constexpr std::uintptr_t LeftShoulder = 0x140;
		inline constexpr std::uintptr_t LeftShoulderRangeMax = 0x728;
		inline constexpr std::uintptr_t LeftShoulderRangeMin = 0x734;
		inline constexpr std::uintptr_t LeftShoulderSize = 0x8AC;
		inline constexpr std::uintptr_t LeftShoulderTposeAdjustment = 0x380;
		inline constexpr std::uintptr_t LeftToeBase = 0x150;
		inline constexpr std::uintptr_t LeftToeBaseRangeMax = 0x740;
		inline constexpr std::uintptr_t LeftToeBaseRangeMin = 0x74C;
		inline constexpr std::uintptr_t LeftToeBaseSize = 0x8B0;
		inline constexpr std::uintptr_t LeftToeBaseTposeAdjustment = 0x3B0;
		inline constexpr std::uintptr_t LeftWrist = 0x160;
		inline constexpr std::uintptr_t LeftWristRangeMax = 0x758;
		inline constexpr std::uintptr_t LeftWristRangeMin = 0x764;
		inline constexpr std::uintptr_t LeftWristSize = 0x8B4;
		inline constexpr std::uintptr_t LeftWristTposeAdjustment = 0x3E0;
		inline constexpr std::uintptr_t Neck = 0x170;
		inline constexpr std::uintptr_t NeckRangeMax = 0x770;
		inline constexpr std::uintptr_t NeckRangeMin = 0x77C;
		inline constexpr std::uintptr_t NeckSize = 0x8B8;
		inline constexpr std::uintptr_t NeckTposeAdjustment = 0x410;
		inline constexpr std::uintptr_t OriginOffset = 0x440;
		inline constexpr std::uintptr_t RightAnkle = 0x180;
		inline constexpr std::uintptr_t RightAnkleRangeMax = 0x788;
		inline constexpr std::uintptr_t RightAnkleRangeMin = 0x794;
		inline constexpr std::uintptr_t RightAnkleSize = 0x8BC;
		inline constexpr std::uintptr_t RightAnkleTposeAdjustment = 0x470;
		inline constexpr std::uintptr_t RightClavicle = 0x190;
		inline constexpr std::uintptr_t RightClavicleRangeMax = 0x7A0;
		inline constexpr std::uintptr_t RightClavicleRangeMin = 0x7AC;
		inline constexpr std::uintptr_t RightClavicleSize = 0x8C0;
		inline constexpr std::uintptr_t RightClavicleTposeAdjustment = 0x4A0;
		inline constexpr std::uintptr_t RightElbow = 0x1A0;
		inline constexpr std::uintptr_t RightElbowRangeMax = 0x7B8;
		inline constexpr std::uintptr_t RightElbowRangeMin = 0x7C4;
		inline constexpr std::uintptr_t RightElbowSize = 0x8C4;
		inline constexpr std::uintptr_t RightElbowTposeAdjustment = 0x4D0;
		inline constexpr std::uintptr_t RightHip = 0x1B0;
		inline constexpr std::uintptr_t RightHipRangeMax = 0x7D0;
		inline constexpr std::uintptr_t RightHipRangeMin = 0x7DC;
		inline constexpr std::uintptr_t RightHipSize = 0x8C8;
		inline constexpr std::uintptr_t RightHipTposeAdjustment = 0x500;
		inline constexpr std::uintptr_t RightKnee = 0x1C0;
		inline constexpr std::uintptr_t RightKneeRangeMax = 0x7E8;
		inline constexpr std::uintptr_t RightKneeRangeMin = 0x7F4;
		inline constexpr std::uintptr_t RightKneeSize = 0x8CC;
		inline constexpr std::uintptr_t RightKneeTposeAdjustment = 0x530;
		inline constexpr std::uintptr_t RightShoulder = 0x1D0;
		inline constexpr std::uintptr_t RightShoulderRangeMax = 0x800;
		inline constexpr std::uintptr_t RightShoulderRangeMin = 0x80C;
		inline constexpr std::uintptr_t RightShoulderSize = 0x8D0;
		inline constexpr std::uintptr_t RightShoulderTposeAdjustment = 0x560;
		inline constexpr std::uintptr_t RightToeBase = 0x1E0;
		inline constexpr std::uintptr_t RightToeBaseRangeMax = 0x818;
		inline constexpr std::uintptr_t RightToeBaseRangeMin = 0x824;
		...
		inline constexpr std::uintptr_t RightWristRangeMax = 0x830;
		inline constexpr std::uintptr_t RightWristRangeMin = 0x83C;
		inline constexpr std::uintptr_t RightWristSize = 0x8D8;
		inline constexpr std::uintptr_t RightWristTposeAdjustment = 0x5C0;
		inline constexpr std::uintptr_t Root = 0x200;
		inline constexpr std::uintptr_t RootRangeMax = 0x848;
		inline constexpr std::uintptr_t RootRangeMin = 0x854;
		inline constexpr std::uintptr_t RootSize = 0x8DC;
		inline constexpr std::uintptr_t RootTposeAdjustment = 0x5F0;
		inline constexpr std::uintptr_t Spine = 0x210;
		inline constexpr std::uintptr_t SpineRangeMax = 0x860;
		inline constexpr std::uintptr_t SpineRangeMin = 0x86C;
		inline constexpr std::uintptr_t SpineSize = 0x8E0;
		inline constexpr std::uintptr_t SpineTposeAdjustment = 0x620;
		inline constexpr std::uintptr_t Waist = 0x220;
		inline constexpr std::uintptr_t WaistRangeMax = 0x878;
		inline constexpr std::uintptr_t WaistRangeMin = 0x884;
		inline constexpr std::uintptr_t WaistSize = 0x8E4;
		inline constexpr std::uintptr_t WaistTposeAdjustment = 0x650;
	}
	...
	namespace Lighting
	{
		...
		inline constexpr std::uintptr_t ClockTime = 0xC8;
		...
		inline constexpr std::uintptr_t Outlines = 0x145;
		inline constexpr std::uintptr_t ShadowColor = 0x10C;
		inline constexpr std::uintptr_t ShadowSoftness = 0x13C;
		inline constexpr std::uintptr_t TimeOfDay = 0xC8;
	}
	...
	{
		inline constexpr std::uintptr_t Length = 0xB8;
		inline constexpr std::uintptr_t ValuesAndTimes = 0xB8;
	}
	...
	{
		inline constexpr std::uintptr_t ColorMapContent = 0xB8;
		inline constexpr std::uintptr_t EmissiveMaskContent = 0xE8;
		inline constexpr std::uintptr_t MaterialPattern = 0x214;
		inline constexpr std::uintptr_t MetalnessMapContent = 0x118;
	...
	namespace MeshPart
	{
		...
		inline constexpr std::uintptr_t MeshID = 0x2F8;
		...
		inline constexpr std::uintptr_t TextureID = 0x328;
		inline constexpr std::uintptr_t VertexCount = 0x370;
	}

	namespace MicroProfilerService
	{
		inline constexpr std::uintptr_t ContextLabel = 0xD0;
	}
	...
	{
		inline constexpr std::uintptr_t Confidential = 0x198;
		inline constexpr std::uintptr_t GUID = 0xD0;
		inline constexpr std::uintptr_t IsCoreScript = 0x100;
		inline constexpr std::uintptr_t LinkedSource = 0x108;
		inline constexpr std::uintptr_t Source = 0x130;
		inline constexpr std::uintptr_t UnrestrictedRequireAllowed = 0x168;
	}

	namespace ParabolaAdornment
	{
		inline constexpr std::uintptr_t A = 0x100;
		inline constexpr std::uintptr_t B = 0x104;
		inline constexpr std::uintptr_t C = 0x108;
		inline constexpr std::uintptr_t Range = 0x10C;
		inline constexpr std::uintptr_t Thickness = 0x110;
	}
	...
	{
		inline constexpr std::uintptr_t LineThickness = 0x114;
		inline constexpr std::uintptr_t StudioSelectionBox = 0x11C;
		inline constexpr std::uintptr_t SurfaceColor3 = 0x108;
		inline constexpr std::uintptr_t SurfaceTransparency = 0x118;
	}

	namespace SelectionSphere
	{
		inline constexpr std::uintptr_t SurfaceColor3 = 0x108;
		inline constexpr std::uintptr_t SurfaceTransparency = 0x114;
	}
	...
	namespace StarterPlayer
	{
		...
		inline constexpr std::uintptr_t GameSettingsAssetIDFace = 0x138;
		inline constexpr std::uintptr_t GameSettingsAssetIDHead = 0x138;
		inline constexpr std::uintptr_t GameSettingsAssetIDLeftArm = 0x138;
		inline constexpr std::uintptr_t GameSettingsAssetIDLeftLeg = 0x138;
		inline constexpr std::uintptr_t GameSettingsAssetIDPants = 0x138;
		inline constexpr std::uintptr_t GameSettingsAssetIDRightArm = 0x138;
		inline constexpr std::uintptr_t GameSettingsAssetIDRightLeg = 0x138;
		inline constexpr std::uintptr_t GameSettingsAssetIDShirt = 0x138;
		inline constexpr std::uintptr_t GameSettingsAssetIDTeeShirt = 0x138;
		inline constexpr std::uintptr_t GameSettingsAssetIDTorso = 0x138;
	...
	{
		inline constexpr std::uintptr_t AlphaMode = 0x1F0;
		inline constexpr std::uintptr_t Color = 0x1D8;
		inline constexpr std::uintptr_t ColorMap = 0xB8;
		inline constexpr std::uintptr_t ColorMapContent = 0xB8;
		inline constexpr std::uintptr_t EmissiveMaskContent = 0xE8;
		inline constexpr std::uintptr_t EmissiveStrength = 0x1F4;
		inline constexpr std::uintptr_t EmissiveTint = 0x1E4;
		inline constexpr std::uintptr_t MetalnessMapContent = 0x118;
		inline constexpr std::uintptr_t NormalMap = 0x148;
		inline constexpr std::uintptr_t NormalMapContent = 0x148;
		inline constexpr std::uintptr_t ResampleMode = 0x1F8;
		inline constexpr std::uintptr_t RoughnessMap = 0x178;
		inline constexpr std::uintptr_t RoughnessMapContent = 0x178;
	...
	{
		inline constexpr std::uintptr_t TargetSurface = 0x100;
	}
	...
	{
		inline constexpr std::uintptr_t SourceText = 0xD0;
	}
	...
	namespace UserInputService
	{
		...
		inline constexpr std::uintptr_t ModalEnabled = 0x1B8;
		...
		inline constexpr std::uintptr_t StatusBarSize = 0xE0;
	...
	namespace Wire
	{
		...
		inline constexpr std::uintptr_t TargetInstance = 0x110;
	...
	namespace Workspace
	{
		...
		inline constexpr std::uintptr_t AllowThirdPartySales = 0x558;
		...
		inline constexpr std::uintptr_t ExpandedTerrain = 0x4D4;
		inline constexpr std::uintptr_t FallHeightEnabled = 0x559;
		inline constexpr std::uintptr_t FluidForces = 0x4D8;
		inline constexpr std::uintptr_t IKControlConstraintSupport = 0x4DC;
		inline constexpr std::uintptr_t ImprovedAnimationConstraint = 0x4E0;
		inline constexpr std::uintptr_t ImprovedPhysicsReplication = 0x4E4;
		inline constexpr std::uintptr_t InsertPoint = 0x3B0;
		inline constexpr std::uintptr_t InterpolationThrottling = 0x4E8;
		inline constexpr std::uintptr_t LayeredClothingCacheOptimizations = 0x4EC;
		inline constexpr std::uintptr_t LuauTypeCheckMode = 0x4F0;
		inline constexpr std::uintptr_t MeshPartHeadsAndAccessories = 0x4F4;
		inline constexpr std::uintptr_t MeshStreamingAndImprovedLods = 0x4F8;
		inline constexpr std::uintptr_t ModelStreamingBehavior = 0x4FC;
		...
		inline constexpr std::uintptr_t PathfindingUseImprovedSearch = 0x504;
		inline constexpr std::uintptr_t PhysicsSteppingMethod = 0x508;
		inline constexpr std::uintptr_t PlayerCharacterDestroyBehavior = 0x50C;
		...
		inline constexpr std::uintptr_t PredictiveStreamingMode = 0x514;
		inline constexpr std::uintptr_t PrimalPhysicsSolver = 0x518;
		inline constexpr std::uintptr_t RejectCharacterDeletions = 0x51C;
		inline constexpr std::uintptr_t RenderingCacheOptimizations = 0x520;
		inline constexpr std::uintptr_t ReplicateInstanceDestroySetting = 0x524;
		inline constexpr std::uintptr_t Retargeting = 0x528;
		inline constexpr std::uintptr_t SandboxedInstanceMode = 0x52C;
		...
		inline constexpr std::uintptr_t StreamOutBehavior = 0x534;
		inline constexpr std::uintptr_t StreamingEnabled = 0x4C4;
		inline constexpr std::uintptr_t StreamingEnabledAlias = 0x4C4;
		inline constexpr std::uintptr_t StreamingIntegrityMode = 0x538;
		inline constexpr std::uintptr_t StreamingMinRadius = 0x53C;
		inline constexpr std::uintptr_t StreamingTargetRadius = 0x540;
		inline constexpr std::uintptr_t Terrain = 0x4A8;
		inline constexpr std::uintptr_t TerrainWeldsFixed = 0x3F8;
		inline constexpr std::uintptr_t ThrottleLevel = 0x544;
		inline constexpr std::uintptr_t TouchEventsUseCollisionGroups = 0x548;
		inline constexpr std::uintptr_t UseFixedSimulation = 0x4C4;
		inline constexpr std::uintptr_t UseFixedSimulationAlias = 0x4C4;
		inline constexpr std::uintptr_t UseNewLuauTypeSolver = 0x550;
		inline constexpr std::uintptr_t ValidateEnabledProximityPrompt = 0x554;
	...
	{
		inline constexpr std::uintptr_t ReferenceCageMeshContent = 0xB8;
